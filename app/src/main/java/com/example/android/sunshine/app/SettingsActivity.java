...
public class SettingsActivity extends PreferenceActivity
        ...
        if (preference instanceof ListPreference) {
            ...
            switch (status) {
                ...
                case SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN:
                    preference.setSummary(getString(R.string.pref_location_unknown_desc, value.toString()));
                    break;
                case SunshineSyncAdapter.LOCATION_STATUS_INVALID:
                    preference.setSummary(getString(R.string.pref_location_error_desc, value.toString()));
                    break;
                default:
                    preference.setSummary(stringValue);
            }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_location_key))) {
            ...
            // Wipe out any potential PlacePicker latlong values so that we can use this text entry.
            ...
            Utility.resetLocationStatus(getBaseContext());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            ...
            if (requestCode == RESULT_OK) {
                ...
                // result from our weather service. we cannot except the weather service to
