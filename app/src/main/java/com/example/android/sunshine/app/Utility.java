...
public class Utility {
     ...
     * by the OpenWeatherMap call.
     *
     * @param context Context to use for retrieving the URL formats
     * @param weatherId from OpenWeatherMap API response
     * @return ur; for the corresponding weather artwork. null if no relation is found.
     */
    public static String getArtUrlForWeatherCondition(Context context, int  weatherId) {
        ...
        // Based on weather code data found at:
        // http://bugs/openweather.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
            ...
            // little difference from Advanced_Android_Development 4.01
    ...
    /**
     * Helper method to provide the correct image according to the weather condition id retured
     * by the OpenWeatherMap call.
     * @param weatherId from OpenWeatherMap API response
     * @return A string url tp am appropriate image or null if no mapping is found
     */
