...
public class LocationEditTextPreference extends EditTextPreference {
    ...
    public LocationEditTextPreference(Context context, AttributeSet attrs) {
        ...
        // Check to see if Google Play services is available. The Place Picker API is available. The Place Picker API
        // is available through Google Play services, so if this is false, we'll just carry on as though this feature
        // does not exist. If it is true, however, we can add a widget to our preference.
